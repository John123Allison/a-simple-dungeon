...
def test_room(player):
    ...
    test_room_inv = [classes.Weapon("dagger","A simple blade, dull and rusted.",5,3),classes.Armor("rags","Gross and worn old rags, provides a tiny amount of protection.",2,1), classes.Item("note","'If you're reading this, you have been chosen. Escape from this place and find me where the sun meets the stars'",0)]
    can_sell = False
